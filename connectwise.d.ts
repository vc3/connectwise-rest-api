...
export namespace Product {
    type IdentifierEnum = 'CloudConsole' | 'CampaignDirector' | 'UserCentric' | 'ChatAssist';
}
...
export namespace Transaction {
    type TypeEnum = 'AP' | 'AR' | 'EE' | 'EI' | 'EO' | 'IA' | 'IT' | 'P' | 'PF' | 'R' | 'RA' | 'RD' | 'RE' | 'RP' | 'ST' | 'SD' | 'ET' | 'RM' | 'FT' | 'PT';
    type ExpenseClassEnum = 'NonReimbursable' | 'Reimbursable' | 'Personal';
}
...
export class ProductsApi {
    ...
    systemProductsGet(params: {
        ...
        page?: number;
        pageSize?: number;
    }, extraQueryParams?: any, extraFetchParams?: any): Promise<Array<Product>>;
    /**
     *
     * Get Product By Id
     * @param productIdentifier
     */
    systemProductsProductIdentifierGet(params: {
        productIdentifier: string;
    }, extraQueryParams?: any, extraFetchParams?: any): Promise<Product>;
    /**
     *
     * Install Product
     * @param productIdentifier
     */
    systemProductsProductIdentifierPost(params: {
        productIdentifier?: string;
    }, extraQueryParams?: any, extraFetchParams?: any): Promise<Product>;
}
...
import { AccountingBatchTransactionsApi, AccountingBatchesApi, AccountingUnpostedExpensesApi, AccountingUnpostedProcurementsApi, AccountingUnpostedinvoicesApi, ActivitiesApi, ActivityStatusesApi, ActivityStopwatchesApi, ActivityTypesApi, AdjustmentDetailsApi, AdjustmentTypesApi, AdjustmentsApi, AgreementSitesApi, AgreementAdditionsApi, AgreementAdjustmentsApi, AgreementBoardDefaultsApi, AgreementTypesApi, AgreementWorkRoleExclusionsApi, AgreementWorkRolesApi, AgreementWorkTypeExclusionsApi, AgreementWorkTypesApi, AgreementsApi, AuditTrailApi, BatchApi, BoardExcludedMembersApi, BoardItemsApi, BoardStatusesApi, BoardSubTypesApi, BoardTeamsApi, BoardTypesApi, BoardsApi, CallbacksApi, CampaignAuditsApi, CampaignEmailsOpenedApi, CampaignFormsSubmittedApi, CampaignLinksClickedApi, CampaignStatusesApi, CampaignSubTypesApi, CampaignTypesApi, CampaignsApi, CatalogComponentsApi, CatalogsItemApi, CategoriesApi, CodesApi, CompaniesApi, CompanyCustomNotesApi, CompanyManagementSummaryReportsApi, CompanyNotesApi, CompanySitesApi, CompanyStatusesApi, CompanyTeamsApi, CompanyTypesApi, ConfigurationStatusesApi, ConfigurationTypeQuestionsApi, ConfigurationTypesApi, ContactsApi, CurrenciesApi, ConfigurationsApi, ContactNotesApi, ContactTypesApi, ContactTracksApi, ContactDepartmentsApi, ContactRelationshipsApi, ContactCommunicationsApi, ConnectWiseHostedSetupsApi, DocumentsApi, ExpenseEntriesApi, ExpenseTypesApi, GroupCompaniesApi, GroupsApi, GroupContactsApi, InfoApi, InvoicesApi, InvoicePaymentsApi, KnowledgeBaseArticlesApi, LinksApi, LocationsApi, MembersApi, ManufacturersApi, MenuEntriesApi, OpportunitiesApi, OrdersApi, OrderStatusesApi, OpportunityNotesApi, OpportunityTeamsApi, OpportunityTypesApi, OpportunityRatingsApi, OpportunityContactsApi, OpportunityStatusesApi, OpportunityForecastsApi, PricingBreaksApi, ProductsApi, ProjectsApi, PrioritiesApi, ProductsItemApi, ProductTypesApi, ProjectNotesApi, ProjectPhasesApi, PricingDetailsApi, PurchaseOrdersApi, ProjectContactsApi, PricingSchedulesApi, ProductComponentsApi, ProjectsTeammembersApi, PurchaseOrderLineItemsApi, ProductPickingShippingDetailsApi, ReportsApi, SourcesApi, SurveysApi, ScheduleTypesApi, SubCategoriesApi, SurveyResultsApi, ScheduleEntriesApi, ShipmentMethodsApi, SurveyQuestionsApi, ScheduleStatusesApi, ScheduleStopwatchesApi, ScheduleReminderTimesApi, TaxCodeXRefsApi, TicketsApi, TaxCodesApi, TicketNotesApi, TicketTasksApi, TimeEntriesApi, TicketStopwatchesApi, UnitOfMeasureConversionsApi, UnitOfMeasuresApi, UserDefinedFieldsApi } from '~connectwise-rest-api/release/api/api';
export class Connectwise {
    readonly AccountingBatchTransactionsApi: AccountingBatchTransactionsApi;
